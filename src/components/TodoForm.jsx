...
const TodoForm = (props) => {
  ...
  return (
    <form style={{ margin: "2em 0em" }} onSubmit={onSubmitHandler}>
      <input type="text" name="todo-baru" id="todoBaru" placeholder="Masukkan Input Anda" style={{ marginRight: "0.5em" }} value={input} bnb onChange={inputHandler} />
      <button type="submit">Tambah To-Do</button>
      <div className="info">
        <p>Total List {props.totalList}</p>
      </div>
    </form>
  );
};
